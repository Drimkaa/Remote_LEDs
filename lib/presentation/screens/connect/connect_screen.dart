...
import 'package:remote_leds/presentation/screens/main/main_screen.dart';
...
class _ConnectPage extends State<ConnectPage> with SingleTickerProviderStateMixin {
  ...
  final StreamController<ConnectStatus> _streamController = StreamController<ConnectStatus>();
  @override
  void initState() {
    super.initState();
    ...
    return Scaffold(
      body: Center(
        child: Wrap(
          ...
          children: [
            TextButton(
                onPressed: () => context.read<ScreenModel>().setPage(const MainScreen()),
