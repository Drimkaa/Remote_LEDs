                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          ...
                          textScaleFactor: 1.5,
                          style: TextStyle(
                            color: model.mode == HomeMode.list ? Colors.white : Theme.of(context).extension<MyColors>()?.inactive,
                          ),
                        ),
                        Switch(
                        ...
                        Text(
                          ...
                          textScaleFactor: 1.5,
                          style: TextStyle(
                            color: model.mode == HomeMode.mode ? Colors.white : Theme.of(context).extension<MyColors>()?.inactive,
                          ),
                        ),
                      ],
                    ),
